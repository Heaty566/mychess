...
describe('chessCommonService', () => {
      ...
      describe('isExistUser', () => {
            ...
            it('Failed user not no playing any game', async () => {
      ...
      //       it('Pass nothing', async () => {
      //             await chessCommonService.startGame(boardId);
      //             const isPlaying = chessCommonService.isPlaying(user1.id);
      ...
      //             const board = await chessCommonService.getBoard('chess-test');
