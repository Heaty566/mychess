...
import { RepositoryModule } from './providers/repository/repository.module';
...
@Module({
      imports: [Config, DBConfig, JwtConfig, AuthModule, SmailModule, UserModule, SmsModule, AwsModule, RepositoryModule],
      controllers: [],
})
