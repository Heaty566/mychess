...
import { ApiResponseBody, ApiServerResponse } from '../../app/interface/serverResponse';
...
export class LocalesService {
       ...
       */
      public translateResponse(res: ApiResponseBody<any>) {
            const formatApi: ApiServerResponse = {
                  message: '',
                  details: {},
                  data: null,
            };
