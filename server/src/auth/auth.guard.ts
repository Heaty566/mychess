...
export class UserGuard implements CanActivate {
      ...
      private async getAuthToken(res: Response, reToken: string) {
            ...
            if (!authTokenId) {
                  ...
                  throw apiResponse.sendError({ details: { messageError: { type: 'error.invalid-token' } } }, 'UnauthorizedException');
            }
      ...
      async canActivate(context: ExecutionContext) {
            ...
            if (req.user.isDisabled) {
                  this.deleteAllAuthToken(res);
                  throw apiResponse.sendError({ details: { messageError: { type: 'error.user-banned' } } }, 'ForbiddenException');
            }
